"""Importing the required libraries such Pygame, sys, time , pygame locals
    and setting up the required global variables"""
...
draw=None
#to set the width and height of the game window
width=400
height=400
...
line_color=(0,0,0)
#setting up and 3*3 board in canvas
...
#setting up a nametag for game window
pg.display.set_caption("Play Tic Tac Toe")

#loads the images as python object with their native sizes
initiating_window =pg.image.load("modified_cover-100x100.png")
...
def draw_status():
    ...
    #setting the font properties like the color,width of the text
...
""" Main Algorithm : A user can win row-wise, 
  column-wise, and diagonally.
 So by using a multidimensional array,
  we can set up the conditions easily. """
...
"""Getting the user input and 
    displaying the “X” or “O”
"""
