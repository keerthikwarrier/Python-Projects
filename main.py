...
""" Define a dictionary that takes in
    the play options for the computer """
...
""" Create a function to disbale the button """
...
""" Create three functions based on the 
    three play options to select the game winner """
...
""" Create the Labels, Frames, and Buttons for our GUI application """
